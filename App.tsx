    ...
    <nav className={`fixed top-0 w-full z-50 transition-all duration-300 border-b ${scrolled ? 'py-3 backdrop-blur-xl bg-lightPrimary/90 dark:bg-darkPrimary/90 border-gray-200 dark:border-white/5 shadow-md' : 'py-5 bg-transparent border-transparent'}`}>
      <div className="container mx-auto px-6 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center space-x-8">
          {NAV_ITEMS.map((item) => (
            <a key={item.label} href={item.href} className="text-sm font-medium dark:text-gray-300 text-gray-600 hover:text-lightAccent dark:hover:text-darkAccent transition-colors relative group">
              {item.label}
        ...
        <div className="md:hidden flex items-center gap-4">
          ...
          <button onClick={() => setIsOpen(!isOpen)} className="dark:text-white text-darkPrimary">
      ...
      {isOpen && (
        <div className="md:hidden absolute top-full left-0 w-full dark:bg-darkSecondary bg-white shadow-xl border-t dark:border-gray-800 border-gray-100 animate-fade-in-up">
          <div className="flex flex-col p-6 space-y-4">
            {NAV_ITEMS.map((item) => (
              <a key={item.label} href={item.href} onClick={() => setIsOpen(false)} className="text-lg font-medium dark:text-white text-gray-800 hover:text-lightAccent dark:hover:text-darkAccent">
                {item.label}
              </a>
            ))}
          </div>
      ...
      <div className="container mx-auto px-6 relative z-10 grid lg:grid-cols-2 gap-12 items-center">
        <FadeIn delay={100}>
          <div className="relative">
            ...
            <h1 className="text-5xl lg:text-7xl font-heading font-bold mb-6 leading-tight text-gray-900 dark:text-white drop-shadow-sm">
              Hello, I'm <br />
            ...
            <h2 className="text-xl lg:text-2xl font-medium text-gray-600 dark:text-gray-300 mb-8 h-8">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <button className="relative px-8 py-3.5 rounded-full border border-gray-300 dark:border-gray-700 bg-white/50 dark:bg-white/5 hover:bg-gray-50 dark:hover:bg-white/10 text-gray-800 dark:text-white font-semibold transition-all flex items-center gap-2 group backdrop-blur-sm z-20 overflow-hidden">
            ...
            <div className="mt-12 flex gap-6 items-center">
              {[
                ...
                <a key={i} href={item.href} target={item.href.startsWith("http") ? "_blank" : undefined} rel={item.href.startsWith("http") ? "noopener noreferrer" : undefined} className="text-gray-400 hover:text-lightAccent dark:hover:text-darkAccent transition-colors transform hover:scale-110 z-20">
                  <item.Icon size={24} />
                </a>
              ))}
            </div>
        ...
        <FadeIn delay={300} className="flex justify-center lg:justify-end relative pointer-events-none">
          <div className="relative w-full max-w-[320px] md:max-w-[400px] aspect-square group pointer-events-auto perspective-1000">
            ...
            <div className="absolute top-10 right-0 lg:-right-4 bg-white dark:bg-darkSecondary p-3 rounded-xl shadow-xl border dark:border-gray-700 animate-float-slow z-20">
               <Brain className="text-lightAccent dark:text-darkAccent" size={24} />
            </div>
             <div className="absolute bottom-10 left-0 lg:-left-4 bg-white dark:bg-darkSecondary p-3 rounded-xl shadow-xl border dark:border-gray-700 animate-float-delayed z-20">
    ...
    <div className="container mx-auto px-6">
      <div className="grid md:grid-cols-2 gap-16 items-start">
        <FadeIn delay={200} className="space-y-6">
            ...
            <h3 className="text-3xl md:text-4xl font-heading font-bold dark:text-white mb-6">Passionate About AI & Learning</h3>
            ...
            <div className="pt-6 grid grid-cols-2 sm:grid-cols-3 gap-6">
               <div className="text-center p-4 bg-white dark:bg-darkPrimary rounded-xl border border-gray-100 dark:border-gray-700/50 shadow-sm hover:shadow-md transition-all hover:-translate-y-1">
                  <h4 className="text-3xl font-bold text-lightAccent dark:text-darkAccent">15+</h4>
                  <p className="text-xs uppercase tracking-wide text-gray-500 mt-1">Projects</p>
               </div>
               <div className="text-center p-4 bg-white dark:bg-darkPrimary rounded-xl border border-gray-100 dark:border-gray-700/50 shadow-sm hover:shadow-md transition-all hover:-translate-y-1">
                  <h4 className="text-3xl font-bold text-purple-600">04</h4>
                  <p className="text-xs uppercase tracking-wide text-gray-500 mt-1">Awards</p>
               </div>
               <div className="text-center p-4 bg-white dark:bg-darkPrimary rounded-xl border border-gray-100 dark:border-gray-700/50 shadow-sm hover:shadow-md transition-all hover:-translate-y-1">
                  <h4 className="text-3xl font-bold text-pink-500">02</h4>
                  <p className="text-xs uppercase tracking-wide text-gray-500 mt-1">Publications</p>
               </div>
            </div>
        </FadeIn>
        ...
        <FadeIn delay={400}>
            <div className="grid grid-cols-1 gap-4">
                {[
                  ...
                  <div key={idx} className="flex items-center p-4 rounded-xl bg-white dark:bg-darkPrimary shadow-sm hover:shadow-md transition-all border border-gray-100 dark:border-gray-800 group">
                      ...
                      <div>
                        <h3 className="text-xs font-bold uppercase text-gray-400">{item.title}</h3>
...
const Skills: React.FC = () => {
  return (
    <section id="skills" className="py-24 relative overflow-hidden bg-white dark:bg-darkPrimary">
      <div className="container mx-auto px-6 mb-12 relative z-10">
        <FadeIn>
          <div className="text-center mb-16">
            ...
            <h3 className="text-3xl md:text-4xl font-heading font-bold dark:text-white">Skills & Technologies</h3>
          </div>
        </FadeIn>
      </div>
              ...
              <div key={idx} className="space-y-6">
                 <div className="container mx-auto px-6">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <h4 className="text-xl font-heading font-bold dark:text-white">{category.title}</h4>
                    </div>
                 </div>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
                        {category.skills.map((skill, i) => {
                           ...
                           return (
                             <div 
                               key={i}
                               className="flex items-center gap-3 px-4 py-3 rounded-xl bg-lightSecondary/50 dark:bg-darkSecondary/50 border border-gray-200 dark:border-gray-800 hover:border-lightAccent dark:hover:border-darkAccent hover:bg-white dark:hover:bg-darkSecondary transition-all duration-300 hover:-translate-y-1"
                             >
                                <div className="p-2 rounded-lg bg-white dark:bg-darkPrimary text-lightAccent dark:text-darkAccent shadow-sm shrink-0">
                                  <SkillIcon size={18} />
                                </div>
                                <span className="font-semibold text-sm md:text-base text-gray-800 dark:text-gray-200">{skill.name}</span>
                             </div>
                           );
                        })}
                    </div>
      ...
      <div className="container mx-auto px-6">
        <FadeIn>
          <div className="text-center mb-16">
            ...
            <h3 className="text-3xl md:text-4xl font-heading font-bold dark:text-white">Featured Projects</h3>
          </div>
        </FadeIn>
        ...
        <div className="grid md:grid-cols-2 xl:grid-cols-2 gap-8">
          {PROJECTS.map((project, idx) => (
            <FadeIn key={project.id} delay={idx % 2 * 100}>
              <div className="group h-full bg-white dark:bg-darkPrimary rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl hover:shadow-lightAccent/10 dark:hover:shadow-darkAccent/10 transition-all duration-300 border border-gray-100 dark:border-gray-800 flex flex-col">
                  <div className="relative h-64 overflow-hidden">
                      ...
                      <div className="absolute top-4 right-4 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 translate-y-2 group-hover:translate-y-0">
                          {project.links.demo && (
                            <a href={project.links.demo} title="Live Site" className="p-2 bg-white dark:bg-darkSecondary rounded-full text-lightAccent dark:text-darkAccent hover:scale-110 transition-transform shadow-lg">
                          ...
                          {(project.links.video || project.links.github) && (
                            project.links.video ? (
                              <button 
                                ...
                                title="Watch Demo" 
                                className="p-2 bg-white dark:bg-darkSecondary rounded-full text-red-500 hover:scale-110 transition-transform shadow-lg"
                              >
                                <PlayCircle size={20} />
                              </button>
                            ) : (
                              <a href={project.links.github} title="View Code" className="p-2 bg-white dark:bg-darkSecondary rounded-full text-gray-800 dark:text-white hover:scale-110 transition-transform shadow-lg">
                                <Github size={20} />
                              </a>
                            )
                          )}
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                      ...
                      {(project.problem || project.solution || project.impact) && (
                        <div className="space-y-3 mb-6 bg-gray-50 dark:bg-darkSecondary/30 p-4 rounded-xl border border-gray-100 dark:border-gray-700/50 text-sm">
                            {project.problem && (
                              <div className="flex gap-3">
                                <div className="min-w-[4rem] text-xs font-bold uppercase text-red-500 pt-0.5">Problem</div>
                                <div className="text-gray-600 dark:text-gray-400">{project.problem}</div>
                              </div>
                            )}
                            {project.solution && (
                              <div className="flex gap-3">
                                <div className="min-w-[4rem] text-xs font-bold uppercase text-yellow-500 pt-0.5">Solution</div>
                                <div className="text-gray-600 dark:text-gray-400">{project.solution}</div>
                              </div>
                            )}
                            {project.impact && (
                              <div className="flex gap-3">
                                <div className="min-w-[4rem] text-xs font-bold uppercase text-green-500 pt-0.5">Impact</div>
                                <div className="text-gray-800 dark:text-gray-200 font-medium">{project.impact}</div>
                              </div>
                            )}
                        </div>
                      )}
                      ...
                      <div className="flex flex-wrap gap-2 mt-auto">
                          {project.tags.map(tag => (
                              <span key={tag} className="px-2.5 py-1 text-xs font-medium rounded-full bg-lightSecondary dark:bg-darkSecondary text-gray-600 dark:text-gray-300 border border-gray-200 dark:border-gray-700">
                                  {tag}
                              </span>
                          ))}
                      </div>
        ...
        <div className="container mx-auto px-6">
            <FadeIn>
              <div className="text-center mb-16">
                ...
                <h3 className="text-3xl md:text-4xl font-heading font-bold dark:text-white">Experience & Education</h3>
              </div>
            </FadeIn>

            <div className="grid lg:grid-cols-2 gap-16">
                <div>
                    <h4 className="text-2xl font-bold font-heading mb-8 dark:text-white flex items-center gap-3">
                    ...
                    <div className="relative border-l-2 border-gray-200 dark:border-gray-800 ml-3 space-y-12">
                        {EXPERIENCES.map((exp, index) => (
                          <div key={exp.id} className="relative pl-8">
                            <span className="absolute -left-[9px] top-0 h-5 w-5 rounded-full border-4 border-white dark:border-darkPrimary bg-lightAccent dark:bg-darkAccent shadow-lg shadow-lightAccent/50 dark:shadow-darkAccent/50"></span>
                            <FadeIn delay={index * 100}>
                              <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-2">
                                <h4 className="text-xl font-bold dark:text-white">{exp.role}</h4>
                                <span className="text-xs font-bold uppercase tracking-wider text-gray-500 bg-gray-100 dark:bg-darkSecondary px-2 py-1 rounded inline-block w-fit mt-1 sm:mt-0">{exp.period}</span>
                              </div>
                              <h5 className="text-lg font-medium text-lightAccent dark:text-darkAccent mb-4">{exp.company}</h5>
                              <p className="text-gray-600 dark:text-gray-400 leading-relaxed bg-lightSecondary/30 dark:bg-darkSecondary/30 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 hover:border-lightAccent/30 dark:hover:border-darkAccent/30 transition-colors">
                                {exp.description}
                              </p>
                            </FadeIn>
                          </div>
                    ...
                    <div className="relative border-l-2 border-gray-200 dark:border-gray-800 ml-3 space-y-12">
                         {EDUCATION.map((edu, index) => (
                          <div key={edu.id} className="relative pl-8">
                             <span className="absolute -left-[9px] top-0 h-5 w-5 rounded-full border-4 border-white dark:border-darkPrimary bg-purple-500 shadow-lg shadow-purple-500/50"></span>
                            <FadeIn delay={200 + index * 100}>
                              <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-2">
                                 <h4 className="text-xl font-bold dark:text-white">{edu.degree}</h4>
                                 <span className="text-xs font-bold uppercase tracking-wider text-gray-500 bg-gray-100 dark:bg-darkSecondary px-3 py-1 rounded whitespace-nowrap mt-1 sm:mt-0">{edu.period}</span>
                              </div>
                              <h5 className="text-lg font-medium text-purple-600 dark:text-purple-400 mb-2">{edu.school}</h5>
                              <p className="text-sm font-medium text-gray-600 dark:text-gray-400 bg-lightSecondary/30 dark:bg-darkSecondary/30 p-4 rounded-xl border border-gray-100 dark:border-gray-800 hover:border-purple-500/30 transition-colors">
                                {edu.details}
                              </p>
                            </FadeIn>
                          </div>
    ...
    <section id="credentials" className="py-24 bg-lightSecondary/30 dark:bg-darkSecondary/30">
      <div className="container mx-auto px-6">
        <FadeIn>
          <div className="text-center mb-16">
            ...
            <h3 className="text-3xl md:text-4xl font-heading font-bold dark:text-white">Awards & Credentials</h3>
          </div>
        </FadeIn>
        ...
        <div className="mb-20">
             <div className="flex items-center gap-3 mb-8">
               ...
               <h3 className="text-2xl font-bold font-heading dark:text-white">Scientific Publications</h3>
             </div>
             
             <div className="grid md:grid-cols-2 gap-6">
               {PUBLICATIONS.map((pub, idx) => (
                  <FadeIn key={pub.id} delay={idx * 100}>
                    <div className="group h-full p-6 rounded-xl bg-white dark:bg-darkPrimary border border-gray-100 dark:border-gray-800 shadow-sm hover:border-pink-500/50 dark:hover:border-pink-500/50 transition-all hover:-translate-y-1 relative overflow-hidden">
                      ...
                      <h4 className="font-bold text-lg mb-3 dark:text-white group-hover:text-pink-600 dark:group-hover:text-pink-400 transition-colors relative z-10">
                        {pub.title}
                      </h4>
                      <p className="text-sm text-gray-600 dark:text-gray-400 mb-4 italic leading-relaxed relative z-10">
                        {pub.authors}
                      </p>
                      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mt-auto border-t border-gray-100 dark:border-gray-800 pt-4 relative z-10">
                        <span className="text-xs font-bold uppercase tracking-wide text-gray-500 bg-gray-100 dark:bg-darkSecondary px-2 py-1 rounded">
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          <div>
            <div className="flex items-center gap-3 mb-8">
               ...
               <h3 className="text-2xl font-bold font-heading dark:text-white">Awards & Honors</h3>
            </div>
              ...
              {AWARDS.map((award, idx) => {
                 ...
                 return (
                  <FadeIn key={award.id} delay={idx * 100}>
                    <div className="flex gap-4 p-5 rounded-xl bg-white dark:bg-darkPrimary border border-gray-100 dark:border-gray-800 shadow-sm hover:shadow-md hover:border-yellow-500/30 transition-all">
                      ...
                      <div>
                        <h4 className="font-bold dark:text-white text-lg">{award.title}</h4>
          ...
          <div>
             <div className="flex items-center gap-3 mb-8">
               ...
               <h3 className="text-2xl font-bold font-heading dark:text-white">Certifications</h3>
             </div>
             <div className="grid grid-cols-2 gap-4">
                {CERTIFICATIONS.map((cert, idx) => (
                  <FadeIn key={cert.id} delay={idx * 50}>
                    <div 
                      className="group cursor-pointer p-4 rounded-xl bg-white dark:bg-darkPrimary border border-gray-100 dark:border-gray-800 hover:border-purple-500/50 hover:shadow-lg transition-all relative overflow-hidden h-full flex flex-col"
                    ...
                    >
                       ...
                       <div className="relative z-10 flex items-start justify-between mb-3">
                          ...
                          <span className="text-[10px] font-bold text-gray-400 border border-gray-200 dark:border-gray-700 px-1.5 py-0.5 rounded">{cert.date}</span>
                       </div>
                       <h4 className="relative z-10 text-sm font-bold dark:text-white leading-tight mb-1 group-hover:text-purple-600 transition-colors">{cert.name}</h4>
                       <p className="relative z-10 text-xs text-gray-500 mb-2">{cert.issuer}</p>
      ...
      {selectedCert && (
        ...
        >
           ...
           <div 
            className="bg-white dark:bg-darkSecondary rounded-2xl overflow-hidden max-w-3xl w-full max-h-[90vh] shadow-2xl flex flex-col relative"
            onClick={e => e.stopPropagation()}
           >
              <div className="p-4 border-b border-gray-100 dark:border-gray-700 flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">{selectedCert.issuer} • {selectedCert.date}</p>
                  </div>
              </div>
...
const Contact: React.FC = () => (
    <section id="contact" className="py-24">
        <div className="container mx-auto px-6 max-w-5xl">
            <FadeIn>
               <div className="grid md:grid-cols-2 gap-12 items-center bg-white dark:bg-darkSecondary rounded-[2rem] p-8 md:p-12 shadow-2xl border dark:border-gray-800 border-gray-100 overflow-hidden relative">
                  ...
                  <div className="relative z-10">
                      <h2 className="text-3xl md:text-4xl font-heading font-bold mb-6 dark:text-white">Let's Connect</h2>
                      ...
                      <div className="space-y-5">
                          <a href="mailto:letransongphuong@gmail.com" className="flex items-center gap-4 p-4 rounded-xl bg-lightSecondary dark:bg-darkPrimary hover:bg-lightAccent/10 dark:hover:bg-darkAccent/10 transition-colors border border-transparent hover:border-lightAccent dark:hover:border-darkAccent group">
                              ...
                              <span className="font-medium dark:text-white">letransongphuong@gmail.com</span>
                          </a>
                          <div className="flex items-center gap-4 p-4 rounded-xl bg-lightSecondary dark:bg-darkPrimary border border-transparent">
                              ...
                              <span className="font-medium dark:text-white">Ho Chi Minh City, Vietnam</span>
                          </div>
                      </div>

                      <div className="flex gap-4 mt-8">
                          <a href="https://github.com/songphuongle" target="_blank" rel="noopener noreferrer" className="p-3 rounded-full bg-lightSecondary dark:bg-darkPrimary text-gray-600 dark:text-gray-400 hover:text-white hover:bg-black dark:hover:bg-white dark:hover:text-black transition-all hover:scale-110"><Github size={20} /></a>
                          <a href="https://www.linkedin.com/in/song-phương-lê-58baa2350" target="_blank" rel="noopener noreferrer" className="p-3 rounded-full bg-lightSecondary dark:bg-darkPrimary text-gray-600 dark:text-gray-400 hover:text-white hover:bg-[#0077b5] transition-all hover:scale-110"><Linkedin size={20} /></a>
                          <a href="#" className="p-3 rounded-full bg-lightSecondary dark:bg-darkPrimary text-gray-600 dark:text-gray-400 hover:text-white hover:bg-[#1DA1F2] transition-all hover:scale-110"><Twitter size={20} /></a>
                      </div>
                  </div>

                  <form className="relative z-10 space-y-4" onSubmit={(e) => e.preventDefault()}>
                      <div>
                          <label className="block text-xs font-bold uppercase mb-2 dark:text-gray-400 ml-1">Name</label>
                          <input type="text" className="w-full px-5 py-3 rounded-xl bg-lightSecondary dark:bg-darkPrimary border border-transparent focus:border-lightAccent dark:focus:border-darkAccent focus:bg-white dark:focus:bg-darkSecondary focus:outline-none transition-all dark:text-white" placeholder="Your Name" />
                      </div>
                      <div>
                          <label className="block text-xs font-bold uppercase mb-2 dark:text-gray-400 ml-1">Email</label>
                          <input type="email" className="w-full px-5 py-3 rounded-xl bg-lightSecondary dark:bg-darkPrimary border border-transparent focus:border-lightAccent dark:focus:border-darkAccent focus:bg-white dark:focus:bg-darkSecondary focus:outline-none transition-all dark:text-white" placeholder="email@example.com" />
                      </div>
                      <div>
                          <label className="block text-xs font-bold uppercase mb-2 dark:text-gray-400 ml-1">Message</label>
                          <textarea rows={4} className="w-full px-5 py-3 rounded-xl bg-lightSecondary dark:bg-darkPrimary border border-transparent focus:border-lightAccent dark:focus:border-darkAccent focus:bg-white dark:focus:bg-darkSecondary focus:outline-none transition-all dark:text-white resize-none" placeholder="Let's build something great..." />
                      </div>
...
const Footer: React.FC = () => (
    <footer className="py-12 border-t dark:border-white/5 border-gray-200 bg-white dark:bg-darkPrimary">
